...
import it.polimi.ingsw.PSP33.view.ViewSample;
...
/* Test di analisi delle funzionalità del server */
/* il test usato per verificare assenza di crash o bug critici, e funzionamento corretto dei visit del controller */
public class MVCTest {
    ...
    public void coreExecution(){
        ...
        list.add(new God(Gods.NOGOD, "descrizione 1"));
        list.add(new God(Gods.APOLLO, "descrizione 2"));
        view.notifyObservers(new SelectedGods(list)); /* test select gods branch message */
        System.out.print("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
        view.notifyObservers(new ChoosenGod(gods.get(1))); /* test choose gods branch message */
        System.out.print("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
